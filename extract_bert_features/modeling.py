...
def layer_norm_and_dropout(input_tensor, dropout_prob, is_training, name=None):
    ...
    output_tensor = tf.compat.v1.layers.dropout(output_tensor, dropout_prob, training=is_training)
...
def attention_layer(from_tensor,
    ...
    attention_probs = tf.compat.v1.layers.dropout(attention_probs, attention_probs_dropout_prob, training=is_training)
        ...
        with tf.compat.v1.variable_scope("layer_%d" % layer_idx):
            ...
            with tf.compat.v1.variable_scope("attention"):
                ...
                with tf.compat.v1.variable_scope("output"):
                    attention_output = tf.compat.v1.layers.dense(
                        ...
                        hidden_size,
                        kernel_initializer=create_initializer(initializer_range))
                    attention_output = tf.compat.v1.layers.dropout(attention_output, hidden_dropout_prob, training=is_training)
            ...
            with tf.compat.v1.variable_scope("output"):
                layer_output = tf.compat.v1.layers.dense(
                    ...
                    hidden_size,
                    kernel_initializer=create_initializer(initializer_range))
                layer_output = tf.compat.v1.layers.dropout(layer_output, hidden_dropout_prob, training=is_training)
